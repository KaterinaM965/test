(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".stage__slider")) new core(".stage__slider", {
        ...
        if (document.querySelector(".participants__slider")) new core(".participants__slider", {
            ...
            navigation: {
                prevEl: ".block-participants__arrow-left",
                nextEl: ".block-participants__arrow-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
            ...
            on: {
                init: function(swiper) {
                    ...
                    const allSlidesItems = document.querySelectorAll(".item-participants:not(.swiper-slide-duplicate)");
